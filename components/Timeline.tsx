      ...
      <section className="wrap relative h-full overflow-hidden p-5">
        ...
        <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
          <li className=''>
            ...
            <motion.div variants={fadeIn('right',0.3)} initial='hidden' whileInView={'show'} viewport={{once:true, amount:0.3}} className="bg-white rounded-xl p-4 timeline-start md:text-start mb-10">
